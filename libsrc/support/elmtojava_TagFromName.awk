#  elmtojava_TagFromName.awk Copyright (c) 1993-2018, David A. Clunie DBA PixelMed Publishing. All rights reserved.
...
NR==1	{
	...
	print ""
	print "private static final String identString = \"@(#) $Header: /userland/cvs/dicom3tools/libsrc/support/elmtojava_TagFromName.awk,v 1.9 2018/03/13 21:09:35 dclunie Exp $\";"
	print ""
}
