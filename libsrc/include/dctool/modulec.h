...
class Macro_DataSetIdentificationMacro : public Module {
	const char *module;
...
public:
	            Macro_DataSetIdentificationMacro(AttributeList *list,InformationEntity ie);
	const char *identify(void) const { return "DataSetIdentificationMacro"; }
	void        write(TextOutputStream& stream,AttributeList *list,ElementDictionary *dict) const ;
	bool        verify(AttributeList *list,AttributeList *parentlist,AttributeList *rootlist,bool verbose,TextOutputStream& log,ElementDictionary *dict) const;
};
...
class Module_MultiResolutionNavigation : public Module {
	const char *module;
	Attribute *ReferencedImageNavigationSequence;
public:
	            Module_MultiResolutionNavigation(AttributeList *list,InformationEntity ie);
	const char *identify(void) const { return "MultiResolutionNavigation"; }
	void        write(TextOutputStream& stream,AttributeList *list,ElementDictionary *dict) const ;
	bool        verify(AttributeList *list,AttributeList *parentlist,AttributeList *rootlist,bool verbose,TextOutputStream& log,ElementDictionary *dict) const;
};
...
class Macro_MultienergyCTCharacteristicsMacro : public Module {
	const char *module;
	Attribute *MonoenergeticEnergyEquivalent;
	Attribute *DerivationAlgorithmSequence;
	Attribute *PerformedProcessingParametersSequence;
public:
...
class Macro_MultienergyCTProcessingMacro : public Module {
	const char *module;
	Attribute *DecompositionMethod;
	Attribute *DecompositionDescription;
	Attribute *DecompositionAlgorithmIdentificationSequence;
	Attribute *DecompositionMaterialSequence;
public:
